...
**you should never enter confidential information into Binder**, including usernames, passwords, or API keys (and this may even violate terms of service for the databases we use). 
